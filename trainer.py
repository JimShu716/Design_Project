...
def parse_args():
    ...
    parser.add_argument('--logtimestamp',type=str,default="none")
...
def main():
    ...
    plt.savefig("./plots/training_loss_{}.png".format(logtimestamp))
    plt.close()
    ...
    plt.savefig("./plots/training_pos_{}.png".format(logtimestamp))
    plt.close()
    ...
    plt.savefig("./plots/training_neg_{}.png".format(logtimestamp))
    plt.close()
